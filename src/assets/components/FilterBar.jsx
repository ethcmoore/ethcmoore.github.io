    ...
    if (pageState == "photo") {
        return (
            <div className="photoFilters" style={{ gridColumn: "span 2" }}>
                ...
                <p className={View == "hocoParade" ? "photoFilterOption activeFilter" : "photoFilterOption"} onMouseUp={filterChagers.changeFilterHocoParade}>IU Homecoming Parade</p>
                ...
                <p className={View == "roeProtest" ? "photoFilterOption activeFilter" : "photoFilterOption"} onMouseUp={filterChagers.changeFilterRoeProtest}>Abortion Rights Protest</p>
            </div>
        )
