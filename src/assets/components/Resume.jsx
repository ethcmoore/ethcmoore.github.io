        ...
        <div className="resume">
            <div className="about">
                ...
                <div>
                    ...
                    <div className="contact"><a href="https://www.linkedin.com/in/ethcmoore/" target="blank"><FaLinkedin /></a><a href="https://github.com/ethcmoore/ethcmoore.github.io" target="blank"><FaGithub /></a><a href="mailto:ethcmoore@gmail.com"><FaEnvelope /></a></div>
                </div>
            </div>
            <div className="resumeMain">
                <section className="resumeBody">
                    <div>
                        <h1>Education</h1>
                        <section>
                            <h2>Indiana University — Bloomington <span>May 2025</span></h2>
                    ...
                    <div>
                        ...
                        <section>
                            ...
                            <ul>
                                <li>
                                    Led dedicated yearbook editors and staff members through developing a visual/verbal theme for the coming school year, helping staffs identify stakeholders and make audience-centered design choices.
                                </li>
                            </ul>
                        </section>
                        <section>
                ...
                <section>
                    <h1>Writing Clips</h1>
                    <ul className="writingClips">
                        {clips.map((clip, index) => (
                            <li key={index}>
                                <a href={clip.link} target="blank">{clip.headline}</a> <small>{clip.date}</small>
                            </li>
                        ))
                        }
                    </ul>
